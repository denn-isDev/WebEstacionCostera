...
export default function Page() {
    ...
    const validationSchema = Yup.object().shape({
        ...
        //costo: Yup.number().typeError('Ingrese un costo válido').positive('Ingrese un costo positivo').nullable(),
    ...
    const sendData = async (data) => {
        ...
        try {
            ...
            const response = await enviarRecursos(`guardar/productos`, productData, token);
            //console.log(response);
            if (response.code === 200) {
                mensajes("Producto creado correctamente", "Producto creado", "success");
