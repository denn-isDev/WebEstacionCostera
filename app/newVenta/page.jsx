...
const Page = () => {
    ...
    const guardarVenta = async () => {
        ...
        const soloHora = fechaLocal.split(",")[1];
        ...
        Swal.fire({
            title: '¿Estás seguro?',
            text: 'Esta acción guardará la venta. ¿Deseas continuar?',
            icon: 'success',
            ...
            if (result.isConfirmed) {
                ...
                const response = await enviarRecursos('guardar/DetalleVenta', data, token);
                if (response.code === 200) {
                    mensajes("Venta guardada correctamente", "Venta guardada", "success");
        ...
        <PrivateRoute>
            <div className='bg-dark col text-center'>
                ...
                <div className="bg-dark p-3" style={{ fontWeight: 'bold' }}>
                    <h1 className="text-white"><strong>Nueva Venta</strong></h1>
                        ...
                        <table className="table table-dark">
                            ...
                            <tbody>
                                {details.map((detail, index) => (
                                    <tr key={index}>
                                        <td>{detail.nombre}</td>
                                        <td>{detail.descripcion}</td> {/* Utiliza la descripción almacenada en el detalle */}
